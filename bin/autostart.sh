...
Pi4*)
	...
	makelink "../zfast-crt.glslp" "$RA/config/PUAE/PUAE.glslp"
	makelink "../zfast-crt.slangp" "$RA/config/PUAE/PUAE.slangp"
...
Pi5*)
	...
	makelink "../zfast-composite.glslp" "$RA/config/PUAE/PUAE.glslp"
	makelink "../zfast-composite.slangp" "$RA/config/PUAE/PUAE.slangp"
